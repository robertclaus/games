    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <h1 style={{ fontSize: 36, fontWeight: 900, letterSpacing: '-1px', color: '#4ade80' }}>
            Nerts!
          </h1>
          <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: 13, marginTop: 4 }}>
            Real-time solitaire racing card game
          </p>
        </div>
        ...
        {mode === 'create' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            {error && (
              <div style={{ color: '#d9534f', fontSize: 13, padding: '8px', background: 'rgba(217,83,79,0.1)', borderRadius: 4 }}>
                {error}
              </div>
            )}
