  ...
  return (
    <div style={styles.page}>
      <div style={styles.card}>
        <div style={styles.title}>📖 Paperback</div>
        <p style={styles.subtitle}>A deck-building word game for 2–4 players</p>
        <input
          style={styles.input}
  ...
  return (
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <p style={{ color: '#C5A028', fontSize: '0.8rem', textAlign: 'center' }}>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  card: {
    ...
    gap: 12,
    textAlign: 'center',
    boxShadow: '0 8px 32px rgba(197,160,40,0.2)',
  },
  title: {
    fontSize: '2.2rem',
    fontWeight: 800,
